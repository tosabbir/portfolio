        ...
        <div class="card">
            <div class="card-body">
                ...
                @php
                    $id = $singleImage->id;
                @endphp
                <form action="{{ route('update.partner.multi.image',$id) }}" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <img id="imageView" src="{{ asset('frontend/assets/img/partner/multiImage/'.$singleImage->images)}}" alt="" style="width: 15%">
                        </div>
                    </div>
