...
<header id="page-topbar">
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index-2.html" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="
                        {{ asset('/backend') }}/assets/images/logo-dark.png" alt="logo-sm" height="22">
                    </span>
                    <span class="logo-lg">
        ...
        <div class="d-flex">
            ...
            {{-- full screen toggle button area start here  --}}
            ...
            {{-- full screen toggle button area end here  --}}
            ...
            <div class="dropdown d-inline-block user-dropdown">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src=" {{ (empty($adminData->adminPic))? asset('/backend/assets/images/admin/avatar-1.jpg') : asset('/backend/assets/images/admin/'.$adminData->adminPic)}}"
                        alt="Header Avatar">
            ...
            {{-- settings toggle button area start here  --}}
            {{-- <div class="dropdown d-inline-block">
            ...
            {{-- settings toggle button area end here  --}}
